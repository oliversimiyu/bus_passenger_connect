...
void main() {
  // Note: This utility requires updating to work with newer image package versions
  // The fill() method API has changed in recent versions

  // Create a 1024x1024 image with blue background
  final image = img.Image(width: 1024, height: 1024);
  // TODO: Update to use new image package API for filling colors
  // ..fill(img.ColorRgb8(25, 118, 210)); // Blue color
